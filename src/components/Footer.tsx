          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-black  p-6 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm mt-2">
                ให้บริการกำจัดปลวก มด แมลงสาบ ยุง หนู 
            ...
            <div>
              ...
              <p className="text-sm mt-2">
              1/112 ซอยสุขาภิบาล 5 ซอย 41 แขวงออเงิน เขตสายไหม กรุงเทพมหานคร 10220
              </p>
              <p className="text-sm mt-2">⏰ เปิดบริการทุกวัน 8:30-17:00 น.</p>
            </div>
          </div>
