...
export default function useCleanService() {
    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row  m-4 md:m-20 gap-5 justify-center">
                      ...
                      <ul className="pl-5 space-y-2 text-black list-none">
                          ...
                          การรับบริการทำความสะอาดที่คำนึงถึงความปลอดภัยและสะอาดเป็นสิ่งสำคัญในการดูแลและรักษาสถานที่ทำงานให้สะอาดและปลอดภัยสำหรับพนักงานและผู้ที่มาเยี่ยมชมหน่วยงานต่างๆ บริการทำความสะอาดที่มีคุณภาพจะไม่เพียงแค่ทำให้สถานที่ดูสะอาด เราให้บริการกับหน่วยงานราชการ
